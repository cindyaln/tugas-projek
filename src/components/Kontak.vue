<template>
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">contact</h2>
          <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">this is my personal contact</p>
        <center>
            <div class="basis-1/2">
            <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="../assets/9.jpeg" width="20000" alt="Neil Avatar">
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">CINDY AULIANI</a>
              </h3>
              <p>siswi smk assalaam</p>
